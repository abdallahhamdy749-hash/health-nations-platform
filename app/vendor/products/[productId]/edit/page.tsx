...
export default function EditVendorProductPage() {
  ...
  const loadProduct = useCallback(async () => {
    try {
      ...
      setForm({
        ...
        catalogUrl: record.catalog_url || "",
        alibabaUrl: record.alibaba_url || "",
        salePrice:
        ...
        currency:
          record.currency === "EGP"
            ...
            : "SAR",
        minimumOrderQuantity: String(
          record.minimum_order_quantity ?? 1
        ),
        stock: String(record.stock ?? 0),
        availableForSale:
          record.available_for_sale ?? true,
        availableForRental:
          record.available_for_rental ?? false,
        monthlyRentalPrice:
          record.monthly_rental_price !== null
            ? String(record.monthly_rental_price)
            : "",
      });
    } catch (error: unknown) {
      setErrorMessage(
  ...
  async function handleSubmit(
    ...
    try {
      ...
      if (!category) {
        throw new Error("اكتب تصنيف المنتج.");
      }
      ...
      const monthlyRentalPrice =
        ...
        form.monthlyRentalPrice.trim()
          ? Number(form.monthlyRentalPrice)
          : null;
      ...
      if (
        ...
        (!Number.isFinite(monthlyRentalPrice) ||
      ...
      const { error } = await supabase
        ...
        .update({
          name_en: nameEn,
          name_ar: emptyToNull(form.nameAr),
          ...
          image_url: emptyToNull(form.imageUrl),
          catalog_url: emptyToNull(form.catalogUrl),
          alibaba_url: emptyToNull(form.alibabaUrl),
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="rounded-[32px] bg-slate-950 p-7 text-white shadow-sm md:p-10">
          ...
          <p
            ...
            dir="rtl"
          >
            عدّل بيانات المنتج والسعر والمخزون.
          </p>
        </header>
        ...
        >
          ...
          <FormSection
            ...
            subtitle="Update price, rental and stock."
          >
            <div className="grid gap-5 md:grid-cols-2">
              <CheckboxField
              ...
              <CheckboxField
                ...
                description="Allow customers to rent this product."
